...
public class VodServiceImpl implements VodService {
    ...
    @Override
    public Boolean deleteVoById(String videoSourceId) {
    ...
    public Boolean getRemoveListByIds(List videoIdList) {
        ...
        try {
            ...
            DeleteVideoRequest request = new DeleteVideoRequest();
            //支持传入多个视频ID，多个用逗号分隔
            String s = org.apache.commons.lang.StringUtils.join(videoIdList, ",");
            System.err.println("视频的ids"+s);
